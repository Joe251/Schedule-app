package com.bignerdranch.android.activitylauncher.Class.widget;
...
//    private static final String TAG = "XListView";
    private static  XListView sXListView;
    ...
    public static XListView get(Context context){
        if(sXListView == null){
            sXListView = new XListView(context);
        }
        return  sXListView;
    }
